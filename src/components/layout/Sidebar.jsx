...
import { Drawer, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Box, Toolbar, Divider, Typography } from '@mui/material';
...
const menuItems = [
    ...
    { text: 'Ανάλυση Αγορών', path: '/reports/products', icon: <FindInPageIcon /> },
    { text: 'Επικοινωνίες', path: '/communications', icon: <ForumIcon /> },
    { text: 'Λίστα Πωλήσεων', path: '/invoices', icon: <ReceiptLongIcon /> },
